...
{		
	...
	try{
		DataExtractor extractor("C:/Users/Brad/Dropbox/Thesis/C++ data analysis/fullData.dat");  // get the data, which is field/amplitude/angle number. maybe bad format? should be consistent with mathematica maybe.
